    ...
    <div className="h-screen bg-[hsl(220,14%,96%)] dark:bg-[hsl(222,84%,5%)] p-3 pb-24 lg:pb-3 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr_300px] gap-3 max-w-[1800px] mx-auto h-[calc(100vh-24px)]">
        ...
        <div className="flex flex-col gap-3 h-full overflow-y-auto pt-4">
          ...
          {/* Task List Card */}
          <div className="bg-transparent backdrop-blur-sm border border-border/50 rounded-[24px] flex-1 flex flex-col overflow-hidden">
            {/* New Task Input */}
        ...
        <div className="hidden lg:flex flex-col h-full">
          <div className="bg-transparent backdrop-blur-sm rounded-[24px] p-5 border border-border/50 flex flex-col h-full overflow-y-auto">
          {/* User Profile */}
          <div className="mb-6">
