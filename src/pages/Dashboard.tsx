    ...
    <div className="h-screen bg-[hsl(220,14%,96%)] dark:bg-[hsl(222,84%,5%)] p-3 pb-24 lg:pb-3 overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr_300px] gap-3 max-w-[1800px] mx-auto h-[calc(100vh-24px)]">
        ...
        <div className="hidden lg:flex flex-col h-full">
          <div className="bg-white/60 dark:bg-black/40 backdrop-blur-xl rounded-[24px] p-4 shadow-sm flex flex-col h-full overflow-hidden border border-white/30 dark:border-white/10">
            {/* Nav Items */}
        ...
        <div className="flex flex-col gap-4 h-full overflow-y-auto">
              ...
              {recentIdeas.length > 0 ? (
                recentIdeas.map((idea) => (
                  <button
                    ...
                    className="bg-white/60 dark:bg-black/40 backdrop-blur-xl rounded-[18px] p-5 shadow-sm text-left hover:shadow-md transition-all group border border-white/30 dark:border-white/10"
                  >
                ...
                <>
                  <div className="bg-white/60 dark:bg-black/40 backdrop-blur-xl rounded-[18px] p-5 shadow-sm border border-white/30 dark:border-white/10">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="text-xl">💡</span>
                    </div>
          ...
          <QuickCapturePopup
            trigger={
              <div className="bg-white/60 dark:bg-black/40 backdrop-blur-xl rounded-[24px] p-4 shadow-sm cursor-pointer hover:shadow-md transition-shadow border border-white/30 dark:border-white/10">
        ...
        <div className="hidden lg:flex flex-col h-full">
          <div className="bg-white/60 dark:bg-black/40 backdrop-blur-xl rounded-[24px] p-5 shadow-sm flex flex-col h-full overflow-hidden border border-white/30 dark:border-white/10">
          {/* En tu cabeza */}
          <div className="mb-8">
