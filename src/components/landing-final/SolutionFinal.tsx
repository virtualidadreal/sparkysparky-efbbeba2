...
/**
 * Solution Final - Light Linear Style
 */
const SolutionFinal = () => {
  const features = [
    { icon: Ear, title: 'Reconoce', desc: 'Entiende de qué hablas sin que se lo expliques.' },
    { icon: FolderSync, title: 'Organiza', desc: 'Clasifica solo. Sin carpetas. Sin esfuerzo.' },
    { icon: Link2, title: 'Conecta', desc: 'Encuentra relaciones que tú no ves.' },
    { icon: Bell, title: 'Recuerda', desc: 'Te avisa cuando algo antiguo es relevante ahora.' },
    { icon: Lightbulb, title: 'Sugiere', desc: 'Propone acciones basadas en lo que piensas.' },
    { icon: Mic, title: 'Escucha', desc: 'Voice-first. Habla y Sparky hace el resto.' },
  ];
