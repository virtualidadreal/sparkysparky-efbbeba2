...
/**
 * Pricing Final Alt - Con "Técnica del Incendio" mejorada (Isra Bravo)
 */
const PricingFinalAlt = () => {
  ...
  return (
    <section id="pricing" className="py-32 px-6 bg-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        {/* MEJORADO: Launch offer con razón más fuerte (técnica del incendio) */}
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                ...
                <br />
                <span className="text-gray-300">A cambio, el precio de early adopter es para siempre.</span>
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="relative p-8 rounded-2xl bg-white border border-gray-200">
            ...
            >
              {isAvailable ? 'Reclamar mi plaza' : 'Empezar ahora'}
...
export default PricingFinalAlt;
