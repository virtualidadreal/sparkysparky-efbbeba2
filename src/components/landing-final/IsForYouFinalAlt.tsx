...
/**
 * Is For You Final Alt - Con "Fuerza del No" más fuerte (Isra Bravo)
 */
const IsForYouFinalAlt = () => {
  const forYou = [
  ...
  // MEJORADO: "No" más fuerte (técnica Fuerza del No - mostrar abundancia)
  const notForYou = [
    'Prefieres organizar manualmente con carpetas y etiquetas',
    'Quieres un ChatGPT con memoria (hay mil opciones, no nos necesitas)',
    'Prefieres quejarte de que "ninguna app funciona" antes que cambiar tus hábitos',
  ];
  ...
  return (
    <section className="py-32 px-6 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        {/* NUEVO: Cierre que refuerza abundancia */}
        <p className="text-center mt-12 text-gray-500">
          No intentamos convencer a nadie. <span className="text-gray-900 font-medium">Solo buscamos a los que ya lo entienden.</span>
        </p>
      </div>
    </section>
  );
...
export default IsForYouFinalAlt;
