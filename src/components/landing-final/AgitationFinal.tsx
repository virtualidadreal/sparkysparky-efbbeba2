/**
 * Agitation Final - Light Linear Style
 * Dark section for contrast, yellow accents
 */
const AgitationFinal = () => {
  const problems = [
    {
    ...
    {
      title: 'La respuesta perfecta',
      desc: 'Que ya tenías escrita. En algún lugar. Hace meses.',
    },
  ];
