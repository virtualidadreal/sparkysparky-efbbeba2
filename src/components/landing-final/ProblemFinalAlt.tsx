/**
 * Problem Final Alt - Con cierre emocional (5 razones de Isra)
 */
const ProblemFinalAlt = () => {
  const stats = [
  ...
  return (
    <section className="py-32 px-6 bg-white relative">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* NUEVO: Cierre emocional (toca: evitar dolor + sentirse importante) */}
        <p className="text-xl sm:text-2xl text-gray-900 font-medium">
          Cada idea perdida es una oportunidad que regalas a alguien más.
        </p>
      </div>
    </section>
  );
...
export default ProblemFinalAlt;
