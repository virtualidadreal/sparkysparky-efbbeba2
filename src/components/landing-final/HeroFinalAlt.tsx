...
/**
 * Hero Final Alt - Con CTAs mejorados (técnica Isra Bravo)
 */
const HeroFinalAlt = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-20 bg-[#F8F7F4] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        {/* Subheadline - MEJORADO (emocional, no descriptivo) */}
        <p className="text-lg sm:text-xl text-gray-500 leading-relaxed max-w-2xl mx-auto mb-12">
          Porque tus mejores ideas no deberían morir en una nota que nunca vuelves a abrir.
        </p>

        {/* CTA - MEJORADO (específico, no genérico) */}
