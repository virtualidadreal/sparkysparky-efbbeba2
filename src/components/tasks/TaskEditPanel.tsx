...
export const TaskEditPanel = ({ task, taskLists, onClose, onDelete }: TaskEditPanelProps) => {
  ...
  return (
    <div className="w-80 bg-card border-l border-border h-screen sticky top-0 flex flex-col">
      {/* Header */}
      <div className="flex items-center justify-between p-4 border-b border-border">
        <h2 className="font-medium text-foreground">Editar tarea</h2>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        <div>
          <textarea
            ...
            rows={4}
            className="w-full text-sm text-foreground bg-muted/30 border border-border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-primary/50 resize-none"
          />
        </div>
        ...
        <div className="relative">
          <button
            ...
            className="w-full flex items-center gap-3 p-3 bg-muted/30 rounded-lg text-left"
          >
        ...
        <div className="relative">
          ...
          {showListDropdown && (
            <div className="absolute z-10 w-full mt-1 bg-card border border-border rounded-lg shadow-lg py-1 max-h-48 overflow-y-auto">
              <button
                onClick={() => {
                  setListId('');
